...
os.system("clear")
mengetik("\33[0;34m[+]\33[0;32mFollow Tiktok Gua Biar Lu Bisa Dapat Rezeki")
os.system("xdg-open https://vt.tiktok.com/ZSNVFNmFy/")
def main():
 os.system("clear")
 mengetik(logo)
 mengetik("\33[0;35mH4X0R_ZXPL01T Tidak bartanggung jawab bila anda menyalah gunakan alat-alat saya !!! \nGunakan dengan bijak BISA MERUSAK PERTEMANAN ANDA 🔥 ")
...
#spam 2
 ...
 for i in range(jum):
    ...
    if "Berhasil mengirim OTP" in pos:
      mengetik("\33[0;32mH4X0R_ZXPL01T SPAM DONE")
    else:
      mengetik("\33[0;31mH4X0R_ZXPL01T BELUM MASUK SPAM NYA")
#spam 3
 head3={
 ...
 for i in range(jum):
    ...
    if "message" in pos:
       mengetik("\33[0;32mH4X0R_ZXPL01T DONE")
    else:
       mengetik("\33[0;32mH4X0R_ZXPL01T DONE")
#spam 4 
 head4={
...
#ulang
time.sleep(4)
lagi=input("\33[0;34msSpam lagi?\33[0;32m(y/n) : ")
if lagi=="y" or lagi=="Y":
 os.system("clear")
 time.sleep(2)
 mengetik(logo)
 ...
 mengetik("\33[0;36mTerimakasih Guyss.. Jangan Lupa Subcribe Channel Youtube Saya Ya...")
 os.system("xdg-open https://www.youtube.com/@root-userploit")
 exit()
else:
 exit()